...
public class PlayerAction {
    ...
    public synchronized void setValidChiiLeft(boolean a_validChii,
            Hai[] a_sarashiHai) {
    ...
    public synchronized void setValidChiiCenter(boolean a_validChii,
            Hai[] a_sarashiHai) {
    ...
    public synchronized void setValidChiiRight(boolean a_validChii,
            Hai[] a_sarashiHai) {
    ...
    public synchronized void setValidKan(boolean a_validKan, Hai[] a_kanHais,
            int a_kanNum) {
