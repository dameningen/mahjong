...
public class Tehai {
    ...
    /**
     * 手牌をコピーする。
     * @param a_dest コピー先の手牌
     * @param a_src コピー元の手牌
     * @param jyunTehaiCopy 純手牌のコピー許可
     */
    public static void copy(Tehai a_dest, Tehai a_src, boolean jyunTehaiCopy) {
        if (jyunTehaiCopy) {
            a_dest.m_jyunTehaiLength = a_src.m_jyunTehaiLength;
            Tehai.copyJyunTehai(a_dest.m_jyunTehai, a_src.m_jyunTehai,
                    a_dest.m_jyunTehaiLength);
        }
    ...
    /**
     * 純手牌をコピーする。
     * @param a_dest コピー先の純手牌
     * @param a_src コピー元の純手牌
     * @param a_length コピーする長さ
     * @return 結果
     */
    public static boolean copyJyunTehai(Hai[] a_dest, Hai[] a_src,
            int a_length) {
        ...
        for (int i = 0; i < m_fuuroNums; i++) {
            if (m_fuuros[i].getType() == Fuuro.TYPE_MINKOU) {
                for (int j = 0; j < m_jyunTehaiLength; j++) {
                    if (m_fuuros[i].getHais()[0].getId() == m_jyunTehai[j]
                            .getId()) {
    ...
    /**
     * 副露の配列をコピーする。
     * @param a_dest コピー先の副露の配列
     * @param a_src コピー元の副露の配列
     * @param a_length コピーする長さ
     * @return 結果
     */
    public static boolean copyFuuros(Fuuro[] a_dest, Fuuro[] a_src,
            int a_length) {
